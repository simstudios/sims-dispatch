...
Language = {
    ['model'] = 'Modelo',
    ['color'] = 'Color',
    ['not_in_car'] = 'Debes de estar en el vehiculo para poder hacer la llamada.',
    ['street'] = 'Street',
    ['storerobbery'] = 'Se ha registrado un robo en un establecimiento, se quiere unidades de manera inmediata en la ubicación.',
    ['bankrobbery'] = 'Se ha registrado un robo en un banco, se quiere a unidades de manera inmediata en la ubicación.',
    ['firedept'] = 'LOS SANTOS FIRE DEPT',
    ['taxi'] = 'DOWNTOWN CAB',
    ['location'] = 'Ubicación',
    ['mechanic'] = 'LOS SANTOS CUSTOM',
    ['policedept'] = 'LOS SANTOS POLICE DEPT'
}

Config.PoliceAmbulanceDispatchIcon = 'CHAR_CALL911'
Config.TaxiDispatchIcon = 'CHAR_TAXI'
Config.MechanicDispatchIcon = 'CHAR_LS_CUSTOMS'

-- Vehicle Colors (español)
Config.Colors = {
    ['0'] = "Negro metálico",
...
-- Creditos a enp-forzar por los colores -> https://github.com/69Terminator69/enp-forzar/blob/main/enp-forzar/config.lua